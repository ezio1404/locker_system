					...
					<div id="sidebar-menu" class=" main_menu_side hidden-print main_menu">
						<div class="menu_section">
							...
							<ul class="nav side-menu">
								...
								<li> <a href="locker.html"><i class="fa fa-lock"></i> Lockers </a> </li>
				...
				<div class="nav_menu">
					<nav>
						...
						<ul class="nav navbar-nav navbar-right">
							<li class="">
								<a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false"> <img src="../image/blank.png" alt="Avatar"> EJ POTOT <span class="fa fa-angle-down"></span> </a>
			...
			<div class="right_col" role="main">
				...
				<div class="row">
					<div class="col-md-12">
								...
								<table class="table table-striped projects" id="datatable-buttons">
									...
									<tbody>
										<tr >
											...
											<td><?php echo $dept_description?></td>
						...
						<button class="btn btn-round btn-warning btn-lg" ><a href="../reports.html">Go Back To Reports</a></button>
                    </div>
				</div>
            </div>
